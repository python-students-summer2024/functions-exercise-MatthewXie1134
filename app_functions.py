...
def print_question(die_1_value, die_2_value, question_type):
    ...
    """
    # complete this function below here
    question_text = f"You rolled a {die_1_value} and a {die_2_value}... What is the {question_type.lower()} of {die_1_value} and {die_2_value}?"
    print(question_text)
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    if question_type == "sum":
        return given_answer == correct_sum
    else:  # question_type == "difference"
        return given_answer == correct_difference
